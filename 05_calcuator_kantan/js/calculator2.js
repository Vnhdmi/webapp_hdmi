...
// ページ上の要素（Element)を参照
// 【Ａ】自分で考える
let elementcalcLog = document.getElementById("calcLog");
let elementResult = document.getElementById("result") ;
let num1 = document.getElementById("num1"); console.log(num1);
...
let elementMult = document.getElementById("mult");
let elementDiv = document.getElementById("div");

let elementEqual = document.getElementById("equal");
let elementCancel = document.getElementById("cancel");
